...
var User = bookshelf.Model.extend({
  ...
  updateUserMetrics: function (metrics, newExtent, transaction) {
    ...
    return this.getTaskingManagerStats(userMetrics.id).then(function (taskManagerStats) {
      ...
      if ((new Date() - gpsTraceUpdatedDate) > 600) {
        return UserComponent.getGpsTraceCount(userMetrics.id).then(function (gpsTraceCount) {
